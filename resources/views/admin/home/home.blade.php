                ...
                <div class="clndr">
                    ...
                    <table class="clndr-table" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            </td><td class="day calendar-day-2015-07-03">
            ...
            <div class="activity_box">
                <div class="scrollbar" id="style-2">
                    <div class="activity-row">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{ asset('/dash') }}/images/5.png' class="img-responsive" alt=""/></div>
                    ...
                    <div class="activity-row">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{ asset('/dash') }}/images/3.png' class="img-responsive" alt=""/></div>
                        <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{ asset('/dash') }}/images/1.png' class="img-responsive" alt=""/></div>
                        <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{ asset('/dash') }}/images/4.png' class="img-responsive" alt=""/></div>
                        <div class="col-xs-8 activity-desc">
